...
export const RE_TME_LINK = /^(https?:\/\/)?(([-a-zA-Z0-9@:%_+~#=]{1,32}\.)?t\.me|pludo\.systems\/drive)/i;
...
export const TME_WEB_DOMAINS = new Set(['t.me', 'web.t.me', 'a.t.me', 'k.t.me', 'z.t.me', 'pludo.systems']);
